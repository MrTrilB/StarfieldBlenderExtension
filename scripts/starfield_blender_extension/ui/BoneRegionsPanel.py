import bpy
from ..types import BoneRegionsReader
from ..utils.utils_bone_regions import br_data, apply_transform

from ..utils import utils_bone_regions as ubr
...
class BoneRegionsPanel(bpy.types.Panel):
	...
	def draw(self, context):
		...
		layout.prop(context.scene, "br_face_type", text="Face Type")
		layout.prop(context.scene, "br_driven_armature", text="Driven Armature")
		
		row = layout.row(align=True)
		row.operator("object.load_face_regions", text="Load Face Data")
		row.operator("object.unload_face_regions", text="Unload")
...
from ..utils.utils_common import __prop_wrapper
